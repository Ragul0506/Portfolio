...
const TERM_LINES = [
  ...
  { text: 'sonar-scanner',                                                                           color: '#00F5FF', delay: 5900  },
  { text: '-Dsonar.projectKey=hrms',                                                                color: '#6B6B8A', delay: 6200,  prefix: '' },
  { text: '-Dsonar.sources=.',                                                                       color: '#6B6B8A', delay: 6500,  prefix: '' },
  { text: '-Dsonar.host.url=https://sonarqube.aryu-devsecops.com',                                 color: '#6B6B8A', delay: 6800,  prefix: '' },
  { text: 'INFO: Scanner configuration file: /opt/sonar-scanner/conf/sonar-scanner.properties',    color: '#6B6B8A', delay: 7350,  prefix: '' },
  { text: 'INFO: Project root configuration file: NONE',                                            color: '#6B6B8A', delay: 7700,  prefix: '' },
  { text: 'INFO: SonarQube Scanner 5.0.1.3006',                                                    color: '#6B6B8A', delay: 7950,  prefix: '' },
  { text: 'INFO: Java 17.0.7 AdoptOpenJDK (64-bit)',                                               color: '#6B6B8A', delay: 8200,  prefix: '' },
  { text: 'INFO: Linux 5.15.0-1031-aws amd64',                                                     color: '#6B6B8A', delay: 8430,  prefix: '' },
  { text: 'INFO: User cache: /root/.sonar/cache',                                                   color: '#6B6B8A', delay: 8660,  prefix: '' },
  { text: 'INFO: Analyzing on SonarQube server 9.9.4 (Developer Edition)',                         color: '#6B6B8A', delay: 8950,  prefix: '' },
  { text: 'INFO: Default locale: "en_US", source code encoding: "UTF-8"',                          color: '#6B6B8A', delay: 9200,  prefix: '' },
  { text: 'INFO: Loaded rules: TypeScript 28, JavaScript 21, Docker 7',                            color: '#6B6B8A', delay: 9500,  prefix: '' },
  { text: 'INFO: 0 high-severity vulnerabilities found',                                            color: '#00FF88', delay: 9850,  prefix: '' },
  { text: 'INFO: 0 critical-severity bugs found',                                                   color: '#00FF88', delay: 10100, prefix: '' },
  { text: 'INFO: Quality Gate passed ✅',                                                            color: '#00FF88', delay: 10450, prefix: '' },
  { text: 'trivy image --severity HIGH,CRITICAL ragulraj/hrms:latest',                             color: '#00F5FF', delay: 10900 },
  { text: '2026-06-17T10:34:11.123+0530 INFO Need to update DB',                                  color: '#6B6B8A', delay: 12000, prefix: '' },
  { text: '2026-06-17T10:34:11.456+0530 INFO Downloaded DB (123456 entries)',                     color: '#6B6B8A', delay: 12900, prefix: '' },
  { text: '2026-06-17T10:34:15.789+0530 INFO Detected OS: alpine',                               color: '#6B6B8A', delay: 13800, prefix: '' },
  { text: '2026-06-17T10:34:15.789+0530 INFO No HIGH or CRITICAL vulnerabilities found',          color: '#00FF88', delay: 14600, prefix: '' },
  { text: 'docker push ragulraj/hrms:latest',                                                       color: '#2496ED', delay: 15500 },
  { text: 'Deploying to aws-prod-ec2...',                                                           color: '#FF9900', delay: 16700 },
  { text: 'nginx -t && nginx -s reload',                                                            color: '#00F5FF', delay: 17500 },
  { text: 'All health checks passed. Uptime: 99.98%',                                              color: '#00FF88', delay: 18700 },
]
